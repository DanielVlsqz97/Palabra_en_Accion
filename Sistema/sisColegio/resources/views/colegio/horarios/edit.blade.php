...
@section('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<h3>Editar Horaio {{'De: '.$horario->hora_inicio.' a:'.$horario->hora_fin}}</h3>
			@if(count($errors)>0)
			...
			{!!Form::model($horario,['method'=>'PATCH','route'=>['horarios.update',$horario->idHorario]])!!}
			{{Form::token()}}
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="time"  name="hora_inicio" required value="{{$horario->hora_inicio}}">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="time"  name="hora_fin" required value="{{$horario->hora_fin}}">
